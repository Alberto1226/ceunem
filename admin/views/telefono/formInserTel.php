<form id="formInserTel" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control border border-success" id="numero" placeholder="Ingrese tu número" name="numero">
    </div>
    <div class="form-group">
        <label for="mensaje">Mensaje</label>
        <textarea class="form-control border border-success" rows="2" id="mensaje" placeholder="Ingresa el mensaje" name="mensaje"></textarea>
    </div>
    <div class="form-group">
