<div class="modal fade " id="addCurModal">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="card card-success border border-success">
          <div class="card-body">
            <!-- form start -->
            <form id="addCur" action="<?php echo constant('URL'); ?>cursos/addCursos" method="POST" enctype="multipart/form-data">
              <div class="card-body">
                <div class="form-group">
                  <label for="nom_curso">Nombre Cursos</label>
                  <input type="text" class="form-control" id="nom_curso" placeholder="Ingrese el nombre de la Cursos" name="nom_curso">
                </div>
                <div class="form-group">
              ...
              <button type="submit" class="btn btn-success btn-block" id="btn-add">Agregar Cursos</button>
              </div>
            </form>
          </div>
          <!-- /.card-body -->
