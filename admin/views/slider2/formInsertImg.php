<div class="card card-default">
    ...
    <div class="card-body">
        <form action="#" method="post" enctype="multipart/form-data" id="formInsertImg2" class="formularioImagenes">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-success btn-block" id="btnImagen_2" name="btnImagen_2">Guardar</button>
            </div>
        </form>
    </div>
</div>