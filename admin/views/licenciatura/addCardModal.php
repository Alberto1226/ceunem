        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card card-success border border-success">
                    <div class="card-body">
                        <!-- form start -->
                        <form id="modalCard" action="<?php echo constant('URL'); ?>licenciatura/addCard" method="POST" enctype="multipart/form-data">
                            <div class="card-body">

                                <div>
                                    <label for="titulo">Titulo</label>
                                    <input type="text" class="form-control border border-success" id="titulo" value="" placeholder="Ingrese el titulo" name="titulo">
                                    <input type="text" class="form-control border border-success" hidden="true" id="id_lic" value="" name="id_lic">
