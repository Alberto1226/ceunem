    ...
    <div class="modal-content ">
      ...
      <div class="modal-body">
        <div class="card card-success border border-success">
          <div class="card-body">
            <!-- form start -->
            <form id="addBlog" action="<?php echo constant('URL'); ?>blog/addArticulo" method="POST" enctype="multipart/form-data">
              <div class="card-body">
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-success btn-block" id="btn-add">Agregar Artículo</button>
          </div>
          </form>
        </div>
        <!-- /.card-body -->
