<div class="card card-default mt-3">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control border border-success" rows="3" id="descripcion" placeholder="Ingresa el texto que se mostrara antes de ver los datos de tu equipo" name="descripcion"></textarea>
    </div>
    <div class="form-group">
