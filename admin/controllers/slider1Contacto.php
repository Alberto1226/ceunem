...
class slider1Contacto extends Controller
{
    public $id;
    private $sliders;
    ...
    function render()
    {
        ...
        $fila = $this->sliders->contarFilas($id_usu, 1,'contacto');
        $this->view->fila = $fila;

        $this->view->render('slider1Contacto/index');
    }
    ...
    function getImg()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            $id_usu = $this->id = $_SESSION['id_usu'];
            $tabla = $this->sliders->getImg($id_usu, 1,'contacto');
