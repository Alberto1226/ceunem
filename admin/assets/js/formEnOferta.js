document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("formEnOferta").addEventListener('submit', insert);
...
function insert(e) {
    e.preventDefault();
    var baseURL = 'http://localhost/ceunem/admin/oferta/addEncabezado';
...
function obtenerDatos() {
    var baseURL = 'http://localhost/ceunem/admin/oferta/getEncabezado';
