...
document.addEventListener("DOMContentLoaded", function () {
  obtenerColores();
  document
    .getElementById("formEditarColores")
...
const valid = (e) => {
  ...
  if (!e.target.value) {
    ...
    showToastr(
      "error",
      "Verifique que haya seleccionado todos los colores",
      "colores"
    );
    campos[campo] = false;
  } else {
...
function obtenerColores() {
  var baseURL = APP_URL + "/admin/colores/getColores";
...
function editar(event) {
  ...
  var baseURL = "/admin/colores/upColors";
  ...
  if (Object.values(campos).every((value) => value === true)) {
    ...
    showSwal2(
      "error",
      "Oops...",
      "Verifique que todos los colores esten seleccionados"
    );
  }
}
