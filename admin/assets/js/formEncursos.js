document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("formEnCurso").addEventListener('submit', insert);
...
function insert(e) {
    e.preventDefault();
    var baseURL = 'http://localhost/ceunem/admin/cursos/addEncabezado';
...
function obtenerDatos() {
    var baseURL = 'http://localhost/ceunem/admin/cursos/getEncabezado';
    const data = { encabezado: 'Cursos' }
