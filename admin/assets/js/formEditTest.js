document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("formStatusTest").addEventListener('submit', statusChange);
...
function editarTest(id) {
    ...
    var baseURL = 'http://localhost/ceunem/admin/testimonios/getTestimonio';
...
function update(event) {
    ...
    var baseURL = 'http://localhost/ceunem/admin/testimonios/upTestimonio';
...
function eliminarTest(id){
    ...
    axios.post(baseURL, data).then((response) => {
        ...
        document.getElementById('lDescripcion').textContent = response.data.testimonio;
...
function del(event) {
    event.preventDefault();
    var baseURL = 'http://localhost/ceunem/admin/testimonios/delTest';
...
function estadoTest(id){
    ...
    var statusTestModal = new bootstrap.Modal(document.getElementById('statusTestModal'), {});
    ...
    axios.post(baseURL, data).then((response) => {
        ...
        document.getElementById('lDescripcionS').textContent = response.data.testimonio;
...
function statusChange(event) {
    event.preventDefault();
    var baseURL = 'http://localhost/ceunem/admin/testimonios/statusTest';
    let encabezados = new Headers();
    let form = new FormData(this)
    axios.post(baseURL, form, { encabezados }).then((response) => {
        if (response.data.status) {
