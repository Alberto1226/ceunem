document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("formEnMas").addEventListener('submit', insert);
...
function insert(e) {
    e.preventDefault();
    var baseURL = 'http://localhost/ceunem/admin/maestria/addEncabezado';
...
function obtenerDatos() {
    var baseURL = 'http://localhost/ceunem/admin/maestria/getEncabezado';
    const data = { encabezado: 'Maestrías' }
