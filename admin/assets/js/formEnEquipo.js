document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("formEnEquipo").addEventListener('submit', insert);
...
function insert(e) {
    e.preventDefault();
    var baseURL = 'http://localhost/ceunem/admin/equipo/addEncabezado';
...
function obtenerDatos() {
    var baseURL = 'http://localhost/ceunem/admin/equipo/getEncabezado';
