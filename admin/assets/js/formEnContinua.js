document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("formEnContinua").addEventListener('submit', insert);
...
function insert(e) {
    e.preventDefault();
    var baseURL = 'http://localhost/ceunem/admin/continua/addEncabezado';
...
function obtenerDatos() {
    var baseURL = 'http://localhost/ceunem/admin/continua/getEncabezado';
    const data = { encabezado: 'Educación Continua' }
