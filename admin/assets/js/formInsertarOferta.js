...
document.addEventListener("DOMContentLoaded", function () {
  document
    .getElementById("formInsertOferta")
    .addEventListener("submit", insert);
...
function agregar() {
  var addOfertaModal = new bootstrap.Modal(
    document.getElementById("addOfertaModal"),
    {}
  );
  addOfertaModal.show();
}
...
function insert(e) {
  e.preventDefault();
  var baseURL = APP_URL + "/admin/oferta/addOferta";
