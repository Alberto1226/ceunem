...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementById("formStatusOferta")
...
function editarOferta(id) {
  var editOfertaModal = new bootstrap.Modal(
    document.getElementById("editOfertaModal"),
    {}
  );
  var baseURL = APP_URL + "/admin/oferta/getOferta";
...
function update(event) {
  ...
  var baseURL = APP_URL + "/admin/oferta/upOferta";
...
function eliminarOferta(id) {
  var deleteOfertaModal = new bootstrap.Modal(
    document.getElementById("deleteOfertaModal"),
    {}
  );
  var baseURL = APP_URL + "/admin/oferta/getOferta";
...
function del(event) {
  event.preventDefault();
  var baseURL = APP_URL + "/admin/oferta/delOferta";
...
function estadoOferta(id) {
  var statusOfertaModal = new bootstrap.Modal(
    document.getElementById("statusOfertaModal"),
    {}
  );
  var baseURL = APP_URL + "/admin/oferta/getOferta";
  var url = APP_URL + "/admin/";
...
function statusChange(event) {
  event.preventDefault();
  var baseURL = APP_URL + "/admin/oferta/statusOferta";
  let encabezados = new Headers();
  let form = new FormData(this);
  axios.post(baseURL, form, { encabezados }).then((response) => {
    if (response.data.status) {
