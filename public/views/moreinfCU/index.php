    ...
    <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
        ...
        <div class="row g-4 justify-content-center">
            ...
            ?>
                ...
                foreach ($this->moreinfCU as $row) {
                    $moreinfCU = new Maestrias();
                    $moreinfCU = $row;
                
                    // Validar si el id_curso coincide con el valor recibido por GET
                    if ($moreinfCU->id_curso == $id_curso) {
                ?>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-white text-center h-100 p-4 p-xl-5">
                            <img class="img-fluid mb-4" src="<?php echo constant('ARCHIVOS') . $moreinfCU->img_url; ?>" alt="">
                            <h4 class="mb-3 " style="color:#A5042D;"><?php echo $moreinfCU->titulo; ?></h4>
                            <p class="mb-4"><?php echo $moreinfCU->descripcion; ?></p>
                        </div>
                    </div>
                <?php
                    }
